...
type PansheeWalletServiceClient interface {
	GetWalletData(ctx context.Context, in *GetWalletDataRequest, opts ...grpc.CallOption) (*GetWalletDataResponse, error)
}
...
func (c *pansheeWalletServiceClient) GetWalletData(ctx context.Context, in *GetWalletDataRequest, opts ...grpc.CallOption) (*GetWalletDataResponse, error) {
	out := new(GetWalletDataResponse)
...
type PansheeWalletServiceServer interface {
	GetWalletData(context.Context, *GetWalletDataRequest) (*GetWalletDataResponse, error)
...
func (UnimplementedPansheeWalletServiceServer) GetWalletData(context.Context, *GetWalletDataRequest) (*GetWalletDataResponse, error) {
